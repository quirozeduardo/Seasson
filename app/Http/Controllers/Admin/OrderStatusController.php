...
use App\DataTables\Admin\OrderStatusDataTable;
...
class OrderStatusController extends AppBaseController
{
    ...
    {
        return $orderStatusDataTable->render('admin.order_statuses.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.order_statuses.show')->with('orderStatus', $orderStatus);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.order_statuses.edit')->with('orderStatus', $orderStatus);
    }
